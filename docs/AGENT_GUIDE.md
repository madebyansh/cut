...
This guide describes the formal CUT 0.4 language and reference backend shipped by `cut-lang` 0.4.0-alpha.2. It does not claim that the alpha already replaces a complete NLE. See [VISION.md](VISION.md) for the end-state contract and [SPEC.md](SPEC.md) for the fuller language and IR specification.
